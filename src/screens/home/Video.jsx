  ...
  return (
    ...
    >
      ...
      <div className="w-full lg:w-1/2 flex flex-col justify-center items-start p-8 lg:p-12 bg-[#e2eeea] text-gray-800">
        <motion.h1
          className="text-3xl md:text-4xl lg:text-5xl font-extrabold mb-4 text-bardum "
        ...
        <motion.button
          className="px-6 py-3 lg:px-8 lg:py-3 bg-bardum text-white rounded-full font-semibold shadow-lg transition-all duration-300 transform hover:scale-105 hover:bg-red-800 focus:outline-none focus:ring-2 focus:ring-green-500"
