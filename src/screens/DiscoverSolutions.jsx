...
const IconSection = ({ Icon, title, description }) => (
  <div className="flex flex-col items-center text-center">
    <div className="bg-red-600 text-white p-6 rounded-full mb-4">
...
const InfoCard = ({ Icon, title, description, link }) => (
  <div className="bg-white p-6 rounded-lg shadow-lg hover:shadow-2xl transition-shadow duration-300">
    ...
    <div className="flex justify-center">
      <Link to="/form">
        <button className="mt-4 px-6 py-2 bg-red-600 text-white rounded-full font-semibold transition-all duration-300 transform hover:scale-105">
          Apply Now
        </button>
      </Link>
    </div>
      ...
      <div className="text-center mt-12">
        {!showMoreCards && (
          <button
            ...
            className="bg-red-600 hover:bg-red-700 text-white font-semibold text-lg tracking-wide rounded-md px-8 py-3 transition-all duration-500"
          >
